...
-(void)openConversationMessagesViewAsModalWith:(ChatUser *)recipient viewController:(UIViewController *)vc attributes:(NSDictionary *)attributes withCompletionBlock:(void (^)(void))completionBlock;
